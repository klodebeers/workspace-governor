...
151-case suite. The content gates are exercised through **real `git commit` calls** in
...
each gate on purpose and requires the suite to notice -- 36 mutations, 33 caught,
0 behaving wrongly at `f6d081a`. Three
